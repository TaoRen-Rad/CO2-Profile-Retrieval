...
ABSCO_PATH = os.environ.get("OCO2_ABSCO_DIR", "data/absco")

absc_paths = {
    "CO2": f"{ABSCO_PATH}/co2_v51.hdf",
    "H2O": f"{ABSCO_PATH}/h2o_v51.hdf",
    "O2": f"{ABSCO_PATH}/o2_v51.hdf"
}
...
class AbsorptionCoefficientModule(nn.Module):
    ...
    def __init__(
        ...
        gas_name: str,
        # file_path: str,
        wavenumber_range: Optional[Tuple[float, float]] = (6180.0, 6280.0),
        use_pca: bool = True,
        ...
        self._file_path = absc_paths[gas_name]
        self._dtype = dtype
